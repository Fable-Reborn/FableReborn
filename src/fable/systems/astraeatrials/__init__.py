    ...
    async def goodspawn(self, ctx):
        ...
        try:
            ...
            **Only followers of Astraea may join.**
            ...
            file = discord.File("assets/images/misc/lyx.webp", filename="lyx.webp")
            ...
            await send_to_channels(embed=embed, content=None, view=view, file_path="assets/images/misc/lyx.webp")
