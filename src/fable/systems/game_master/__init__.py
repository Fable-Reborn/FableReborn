...
from fable.core.converters import CrateRarity, IntFromTo, IntGreaterThan, UserWithCharacter
from fable.core.items import ItemType
...
from fable.utils.checks import has_char, is_gm, is_god
...
class GameMaster(commands.Cog):
    ...
    async def makehtml(self, ctx: Context) -> None:
        ...
        with open("assets/templates/html/commands.html") as f:
            base = f.read()
        with open("assets/templates/html/cog.html") as f:
            cog = f.read()
        with open("assets/templates/html/command.html") as f:
            command = f.read()
    ...
    async def gmreplaybattle(self, ctx, battle_id: str):
        ...
        **Example**: `$gmreplaybattle a1b2c3d4-e5f6-7890-abcd-ef1234567890`
        ...
        from fable.systems.battles.core.battle import Battle
